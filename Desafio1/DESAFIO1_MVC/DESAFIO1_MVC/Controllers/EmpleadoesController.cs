...
namespace DESAFIO1_MVC.Controllers
{
    public class EmpleadoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,FechaNacimiento,FechaContratacion,Salario,Descripcion,DepartamentoId")] Empleado empleado)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,FechaNacimiento,FechaContratacion,Salario,Descripcion,DepartamentoId")] Empleado empleado)
        {
            ModelState.Remove("Departamento");
            if (id != empleado.Id)
            {
